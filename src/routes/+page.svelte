...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4 py-10 space-y-6">
    <div class="text-left mb-12 max-w-md w-full">
        <h1 class="text-3xl text-gray-800 mb-8"><span class="font-bold">Welcome!</span>
            <br>
            This is a page about all-things-husky.
        </h1>
        <h2 class="text-2xl text-gray-700">Currently you can only generate random husky pics.</h2>
    </div>

    <div id="image-container" class="w-full max-w-[25em] h-[20em] sm:h-[25em] p-4 flex items-center justify-center border-4 border-gray-500 rounded-4xl shadow-lg bg-gray-100">
    ...
    <button
        ...
        class="bg-blue-500 hover:bg-blue-600 active:bg-blue-900 focus:ring-2 focus:ring-blue-400 text-white font-semibold px-6 py-2 rounded-2xl shadow-lg transition"
    >
        New Husky
    </button>
