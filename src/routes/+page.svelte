...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-50 space-y-6">
    ...
    <div id="image-container" class="w-[30em] h-[30em] p-4 flex items-center justify-center border-4 border-gray-500 rounded-4xl shadow-lg bg-gray-100">
    ...
    <button
        ...
        class="bg-blue-500 hover:bg-blue-600 active:bg-blue-900 text-white font-semibold px-6 py-2 rounded-2xl shadow-lg transition"
    >
        New Husky
    </button>
